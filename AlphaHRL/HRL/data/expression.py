...
from AlphaHRL.HRL.utils.maybe import Maybe, some, none
from AlphaHRL.alphahrl_qlib.stock_data import StockData, FeatureType
...
class Var(RollingOperator):
    def _apply(self, operand: Tensor) -> Tensor: return operand.var(dim=-1, correction=0)
